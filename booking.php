  <?php 
        ...
        if (isset($_POST['simpan'])) {
            ...
            if ($queryHapusTemp) {
               echo "<script> alert('Terimakasih Data Berhasil Disimpan'); location.href='index.php?hal=pembayaran/pembayaran&invoice=$invoice' </script>";exit;
            }
          ...
          <div class="col-md-12">
            <div class="process-item highlight text-center">
              ...
              <div class="process-item-content"> 
                ...
                <div class="col-md-2"><button type="submit" name="simpan" class="btn btn-success"><span class="fa fa-save"></span> Simpan</button></div>
              </div>
              <br>
